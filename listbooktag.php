...
<div class="container">
    <div class="row">
        <div class="col mt-md-3">
            <h1 class="text-center mb-md-3">Book Tag List</h1>
             <table class="table table-striped table-hover text-center">
  <thead class="table-dark">
    <tr>
      <th scope="col">#</th>
      <th scope="col">BookTag</th>
 ...
 <tbody class="table-info">
    ...
    foreach($category as $key => $value){
      ...
      <tr>
        ...
        <td>
          <a href="editbooktag.php?id=<?php echo $id; ?>" class="btn btn-info">
            <i class = 'fa fa-edit'></i>Edit
          </a>
      </td>

      <td>
          <a href="deletebooktag.php?id=<?php echo $id; ?>" class="btn btn-danger">
