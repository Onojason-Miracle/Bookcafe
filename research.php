        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown"> 
            <?php 
              ...
              $obj = new Libarian;
              $output=$obj->getKids(3);
             // var_dump($output);
              foreach($output as $key => $value){
                $id=$value['booktag_id'];

            ?>
            <li><a class="dropdown-item books" href="http://localhost/bookcafe2/research.php?id=<?php echo $id ?>"><?php echo $value['booktag'];?></a></li>
            <?php
               }
             ?>
...
<div class="col trans">
  <h1 class="text-center">Research Section</h1>
...
<div class="row mt-4">
  ...
  <div class="card-body text-center" style="background-color: black; color:white">
    <h5 class="card-title" id="imgbg"><?php echo $value['book_name']; ?></h5>
     <p class="pbutton">
