        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown"> 
            <?php 
              ...
              $obj = new Libarian;
              $output=$obj->getKids(1);
             // var_dump($output);
              foreach($output as $key => $value){
                $id=$value['booktag_id'];

            ?>
            <li><a class="dropdown-item books" href="http://localhost/bookcafe2/kids.php?id=<?php echo $id ?>"><?php echo $value['booktag'];?></a></li>
            <?php
               }
             ?>
...
<div class="col trans">
  <h1 class="text-center ">Kids/Teens Section</h1>
